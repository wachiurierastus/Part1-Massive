...
def en_base_df(input_directory_path: str) -> DataFrame:
    ...
    files = FileParsing.list_of_valid_files(directory_path=input_directory_path)
...
class TaskHelpers:
    def __init__(self, input_directory_path: str, output_directory_path):
    ...
    def per_language_pivot_en(self, filepath: str) -> DataFrame:
        ...
        df: DataFrame = FileParsing.dataframe_gen_from_jsonl(file_path=file_path)
        # Renaming the columns
    ...
    def per_language_pivot_en(self, lang_directory_path: str, filepath: str, input_directory_path) -> DataFrame:
        '''
        This function returns a dataframe where utt, annon_utt are added to the base dataframe
        for the specific passed file path
